...
export default function ItemDetailScreen({ route, navigation }) {
    ...
    const fetchOwnerInfo = async () => {
      try {
        ...
        if (error) {
          ...
          setOwnerName(fullName || "Unknown Owner")
        }
      } catch (err) {
  ...
  const toggleLike = async () => {
    ...
    try {
      ...
      if (liked) {
        // Unlike
        const { error } = await supabase.from("liked_items").delete().eq("user_id", user.id).eq("item_id", item.item_id)
      ...
      <View style={styles.container}>
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <Text style={styles.price}>
            ₱{Number.parseFloat(item.price_per_day).toFixed(2)}
          ...
          <View style={styles.section}>
            ...
            <View style={styles.infoCard}>
              ...
              <View style={styles.infoRow}>
                ...
                <Text style={styles.infoValue}>₱{Number.parseFloat(item.deposit_fee || 0).toFixed(2)}</Text>
              </View>
              <View style={styles.infoRow}>
            ...
            <View style={styles.reviewCard}>
              ...
              <View style={styles.stars}>
                {Array(5)
                  .fill()
                  .map((_, idx) => (
                    <FontAwesome key={idx} name="star" size={16} color="#FFA500" />
                  ))}
              </View>
              <Text style={styles.reviewText}>
                This tool set didn't just fix my broken shelf—it fixed a piece of my soul.
              </Text>
            </View>
          </View>
